    ...
    return(
        <div>
            <div className={style.titleOffre}>
                    <Typography color={"#94A1b2"} variant="h3" fontWeight={"bold"} fontFamily={"Bitter"}>DÉCOUVREZ</Typography> 
                    <Typography color={"#94A1b2"} variant="h3" fontWeight={"bold"} fontFamily={"Bitter"}>nos offres</Typography> 
                </div>
